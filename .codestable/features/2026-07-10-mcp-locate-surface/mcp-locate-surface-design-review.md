...
# mcp-locate-surface feature design 审查报告
...
- Goal：MCP capability/list/call、typed error、cancellation 与 shutdown。
- Steps：4 条，均有可独立判断的 exit signal。
- Checks：14 条，均能追溯到 design、roadmap contract 或 artifact。
...
- Windows stdio EOF/signal 与双重 cancellation 需实测。
