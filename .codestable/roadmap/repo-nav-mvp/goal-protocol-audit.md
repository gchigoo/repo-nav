...
```bash
python3 .codestable/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/repo-nav-mvp
```
...
写 `.codestable/roadmap/repo-nav-mvp/goal-audit.md`：
...
同时写 `.codestable/roadmap/repo-nav-mvp/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
