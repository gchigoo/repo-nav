...
- 顺序：9/12
- Roadmap item：`input-abort-contract-v2`
- 依赖：`streaming-ripgrep`
- 性质：`mixed`
...
- Design review：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-design-review.md`
- Implementation review：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-review.md`
- QA：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-qa.md`
- Acceptance：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-acceptance.md`
- Evidence pack：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-evidence-pack.md`
- Gate results：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-gate-results.json`
- DoD results：`.codestable/features/2026-07-24-input-abort-contract-v2/input-abort-contract-v2-dod-results.json`

## 2. Delivery And Core Path

- 一句话交付物：可选 question、路径/语义归一化分离与 abort/status aggregation seam
...
- `npm run build`
- `npm run typecheck`
- `npm test -- --group input-abort-contract-v2`
- `npm test -- --group locate-status --group streaming-ripgrep --group request-snapshot-cache --group relevance-ranking-budget --group canonical-locate-bridge --group public-output-v2`
- `npm test`
- `npm run test:golden -- --group input-abort-contract-v2`
...
2. Review：加载 `cs-code-review` 并使用独立 Task agent，输出 `input-abort-contract-v2-review.md`。
3. QA：加载 `cs-feat` QA，输出 `input-abort-contract-v2-qa.md` 与真实运行证据。
4. Acceptance：加载 `cs-feat` accept，输出 `input-abort-contract-v2-acceptance.md` 并更新 checks/items。
