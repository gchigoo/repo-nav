...
- 顺序：12/12
- Roadmap item：`public-beta-release`
- 依赖：`request-snapshot-cache`, `streaming-ripgrep`, `language-capability-boundary`
- 性质：`mixed`
...
- Design review：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-design-review.md`
- Implementation review：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-review.md`
- QA：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-qa.md`
- Acceptance：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-acceptance.md`
- Evidence pack：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-evidence-pack.md`
- Gate results：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-gate-results.json`
- DoD results：`.codestable/features/2026-07-24-public-beta-release/public-beta-release-dod-results.json`

## 2. Delivery And Core Path

- 一句话交付物：原子切换 production locate schema v2、发布元数据与 beta release gate
...
2. Review：加载 `cs-code-review` 并使用独立 Task agent，输出 `public-beta-release-review.md`。
3. QA：加载 `cs-feat` QA，输出 `public-beta-release-qa.md` 与真实运行证据。
4. Acceptance：加载 `cs-feat` accept，输出 `public-beta-release-acceptance.md` 并更新 checks/items。
