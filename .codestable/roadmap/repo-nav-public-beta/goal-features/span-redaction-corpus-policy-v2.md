...
# span-redaction-corpus-policy-v2 Goal 执行规格

## 1. Identity And Inputs

- 顺序：2/12
- Roadmap item：`span-redaction-corpus-policy-v2`
...
- Design review：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-design-review.md`
- Implementation review：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-review.md`
- QA：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-qa.md`
- Acceptance：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-acceptance.md`
- Evidence pack：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-evidence-pack.md`
- Gate results：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-gate-results.json`
- DoD results：`.codestable/features/2026-07-24-span-redaction-corpus-policy-v2/span-redaction-corpus-policy-v2-dod-results.json`

## 2. Delivery And Core Path

- 一句话交付物：span-based 单次物化、传播资格 corpus 与 placeholder 永不二次扫描
...
- `npm test -- --group public-output-v2 --case span-redaction`
- `npm test -- --group public-output-v2 --case corpus-policy --case field-redaction`
- `npm test -- --group public-output-v2 --case corpus-boundaries`
- `npm run test:golden -- --group public-output-v2`
- `npm test -- --group public-output-v2 --case redaction-amplification && npm run test:golden -- --group public-output-v2`
- `npm test -- --group public-output-v2 --case phone-corpus-policy`
- `npm test -- --group public-output-v2 --case public-safe-ranking-key`
...
2. Review：加载 `cs-code-review` 并使用独立 Task agent，输出 `span-redaction-corpus-policy-v2-review.md`。
3. QA：加载 `cs-feat` QA，输出 `span-redaction-corpus-policy-v2-qa.md` 与真实运行证据。
4. Acceptance：加载 `cs-feat` accept，输出 `span-redaction-corpus-policy-v2-acceptance.md` 并更新 checks/items。
