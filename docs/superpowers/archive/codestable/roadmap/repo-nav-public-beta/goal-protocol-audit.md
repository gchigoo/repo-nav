...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/repo-nav-public-beta
```
...
写 `.codestable/roadmap/repo-nav-public-beta/goal-audit.md`：
...
# repo-nav-public-beta Goal 最终审计
...
同时写 `.codestable/roadmap/repo-nav-public-beta/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
