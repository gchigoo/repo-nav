...
本文件复制到 `.codestable/roadmap/repo-nav-public-beta/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。
...
- `.codestable/roadmap/repo-nav-public-beta/goal-features/*.md`
...
Plan: .codestable/roadmap/repo-nav-public-beta/goal-plan.md
Protocol: .codestable/roadmap/repo-nav-public-beta/goal-protocol.md
```
