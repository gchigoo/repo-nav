...
describe.runIf(isSelected(baselineIdentity))(
  'text engine no-result baseline',
  () => {
...
describe.runIf(isSelected(timeoutIdentity))(
  'text engine partial timeout evidence',
  () => {
