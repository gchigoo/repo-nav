...
const BASE_BINDINGS: readonly PlatformCaseBindingV1<PlatformContractIdV1>[] =
  Object.freeze([
    ...
    Object.freeze({
      ...
      surface: 'unit',
      group: 'cross-platform-baseline',
      executableCaseId: 'process-stdout-n-plus-one-boundary',
      applicableOs: ALL_OS,
      requiredAssertionIds: Object.freeze([
        'exact-n-success',
        'n-plus-one-limit',
    ...
    Object.freeze({
      ...
      surface: 'unit',
      group: 'cross-platform-baseline',
      executableCaseId: 'process-stderr-n-plus-one-boundary',
      applicableOs: ALL_OS,
      requiredAssertionIds: Object.freeze([
        'exact-n-success',
        'n-plus-one-limit',
    ...
    Object.freeze({
      ...
      requiredEvidenceHashIds: Object.freeze([]),
      fixture: 'testkit/fixtures/process-v2/byte-writer-v2.ts',
      assertionOwner: 'test/unit/safe-process-streaming-v2.spec.ts',
    }),
    Object.freeze({
      ...
      requiredEvidenceHashIds: Object.freeze([]),
      fixture: 'testkit/fixtures/process-v2/streaming-finalizer-platform-v2.ts',
      assertionOwner: 'test/unit/safe-process-streaming-v2.spec.ts',
    }),
    Object.freeze({
      ...
      requiredEvidenceHashIds: Object.freeze([]),
      fixture: 'testkit/fixtures/ripgrep/stream-partitions-v2.ts',
      assertionOwner: 'test/unit/ripgrep-json-line-consumer-v2.spec.ts',
    }),
    Object.freeze({
