...
export const VERSION_AUTHORITIES_V2: readonly VersionAuthorityV2[] =
  Object.freeze([
    ...
    Object.freeze({
      ...
      wiring: 'wired',
      expected: 'repo-nav-2.0.0.tgz',
    }),
    Object.freeze({
      id: 'installed-package-json',
      module: 'tools/release/release-candidate.mjs',
      binding: 'fresh consumer node_modules/repo-nav/package.json.version',
      wiring: 'wired',
      expected: '2.0.0',
    }),
    Object.freeze({
      ...
      wiring: 'wired',
      expected: 'pkg:npm/repo-nav@2.0.0',
    }),
    Object.freeze({
